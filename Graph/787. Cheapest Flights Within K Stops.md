...
## Notes
This is a variant of the Dijkstra's Algorithm. We include a new variable in the node to check how deep we are in the search. By using Dijkstra's Algorithm, we can return the answer the first time we find one.
