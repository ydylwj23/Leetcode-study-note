...
class Solution {
    public int countShips(Sea sea, int[] topRight, int[] bottomLeft) {
        ...
        //split the rectangel into 4 area
...
## Complexity Analyze
Time complexity: O(10*log(m*n))  
Space complexity: O(log(m * n))

## Notes
Divide and conquer: split a rectangle into 4 pieces each time to search for the target.  
